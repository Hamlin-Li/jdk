...
public class FPComparison {
    ...
    @Benchmark
    public void equalFloatResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (f1[i] == f2[i]) ? ro1 : ro2;
        }
    }

    @Benchmark
    public void equalDoubleResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (d1[i] == d2[i]) ? ro1 : ro2;
        }
    }

    @Benchmark
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void equalDoubleResObjectSingle(Blackhole bh) {
        bh.consume((d1[0] == d2[0]) ? ro1 : ro2);
    }

    @Benchmark
    public void lessFloatResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (f1[i] < f2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void lessDoubleResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (d1[i] < d2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void lessEqualFloatResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (f1[i] <= f2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void lessEqualDoubleResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (d1[i] <= d2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void greaterFloatResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (f1[i] > f2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void greaterDoubleResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (d1[i] > d2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualFloatResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (f1[i] >= f2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualDoubleResObject() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resObject[i] = (d1[i] >= d2[i]) ? ro1 : ro2;
        }
    }
    ...
    @Benchmark
    public void equalFloatResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (f1[i] == f2[i]) ? rc1 : rc2;
        }
    }

    @Benchmark
    public void equalDoubleResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (d1[i] == d2[i]) ? rc1 : rc2;
        }
    }

    @Benchmark
    public void lessFloatResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (f1[i] < f2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void lessDoubleResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (d1[i] < d2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void lessEqualFloatResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (f1[i] <= f2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void lessEqualDoubleResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (d1[i] <= d2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterFloatResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (f1[i] > f2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterDoubleResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (d1[i] > d2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualFloatResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (f1[i] >= f2[i]) ? rc1 : rc2;
        }
    }
    ...
    @Benchmark
    public void greaterEqualDoubleResClass() {
        for (int i = 0; i < INVOCATIONS; i++) {
            resClass[i] = (d1[i] >= d2[i]) ? rc1 : rc2;
        }
    }
