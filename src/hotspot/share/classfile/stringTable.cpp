...
void StringTable::create_table() {
  ...
  _local_table = new StringTableHash(GlobalCounter::StringTableScope, start_size_log_2, END_SIZE, REHASH_LEN);
...
bool StringTable::do_rehash() {
  ...
  StringTableHash* new_table = new StringTableHash(GlobalCounter::StringTableScope, new_size, END_SIZE, REHASH_LEN);
