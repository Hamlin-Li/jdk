...
void SymbolTable::create_table ()  {
  ...
  _local_table = new SymbolTableHash(GlobalCounter::SymbolTableScope, start_size_log_2, END_SIZE, REHASH_LEN);
...
bool SymbolTable::do_rehash() {
  ...
  SymbolTableHash* new_table = new SymbolTableHash(GlobalCounter::SymbolTableScope, new_size, END_SIZE, REHASH_LEN);
