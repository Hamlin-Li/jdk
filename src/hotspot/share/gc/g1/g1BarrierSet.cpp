...
G1BarrierSet::G1BarrierSet(G1CardTable* card_table) :
  ...
  _satb_mark_queue_buffer_allocator("SATB Buffer Allocator", G1SATBBufferSize, GlobalCounter::SATBScope),
  _dirty_card_queue_buffer_allocator("DC Buffer Allocator", G1UpdateBufferSize, GlobalCounter::DirtyCardScope),
